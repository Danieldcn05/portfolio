...
import timeTracker1 from './assets/images/time_tracker_1.png';
import timeTracker2 from './assets/images/time_tracker_2.png';
import timeTracker3 from './assets/images/time_tracker_3.png';
...
function App() {
  ...
  const proyectos = [
    ...
    { name: 'Time Tracker', subtitle: 'Proyecto Full Stack con Python', img: timeTracker1, linkGit: 'https://github.com/Danieldcn05/time_tracker', info: 'Aplicación de rastreo de tiempo de uso de aplicaciones desarrollada en Python. Utiliza psutil y subprocess para monitorear procesos en tiempo real, registrando cuándo se inician y cierran las aplicaciones seleccionadas. Los datos se almacenan en una base de datos SQLite para análisis posterior. La interfaz gráfica, creada con Tkinter, permite al usuario gestionar las aplicaciones a rastrear y visualizar el tiempo de uso.', images: [timeTracker1,timeTracker2,timeTracker3] }
  ];
